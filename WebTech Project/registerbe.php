            ...
            <div class="agile-row">
                ...
                <div class="login-agileits-top"> 
                    <form action="after_register.php" method="post"> 
                        <div class="input-row">
                            <input type="text" class="user" name="fname" placeholder="First Name" required=""/><br><br>
                            <input type="text" class="user" name="lname" placeholder="Last Name" required=""/><br><br> 
                            <input type="password" class="user" name="password" placeholder="Password" required=""/><br><br> 
                            <input type="text" class="email" name="eid" placeholder="Enter Your Email" required=""/><br><br>
                            <input type="cost" class="user" name="cno" placeholder="Contact Number" required=""/>  <br><br>
                           
                            <input type="text" class="user" name="Address" placeholder="Address" required=""/> <br><br>
                            <input type="cost" class="user" name="pin" placeholder="PinCode" required=""/> <br><br> 
                        </div>
                        <br><br>                        
